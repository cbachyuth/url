...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='https://t.me/helpline_4u')
                  ]]
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            photo="https://telegra.ph/file/5e96340a91470256b387a.jpg",
    ...
    if data.split("-", 1)[0] == "BATCH":
        sts = await message.reply("<b>ᴀᴄᴄᴇssɪɴɢ ꜰɪʟᴇs…/</b>")
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://telegram.me/Telugudubbing_moviess') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
...
async def send_msg(bot, message):
    if message.reply_to_message:
        ...
        await message.reply_text("<b>Use this command as a reply to any message using the target chat id. For eg: /Reply userid</b>")
