...
auth_channel = environ.get('AUTH_CHANNEL', '-1001505294843')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://telegram.me/helpline_4u')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <b>{file_caption} \n Size :- <i>{file_size}</i> \nᴊᴏɪɴ ɴᴏᴡ: [KUMBHIPAAKAM](https://telegram.me/movies_seriesupdates)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "ɴᴀᴍᴇ: <b>{file_caption} \n Size :- <i>{file_size}</i> \nᴊᴏɪɴ ɴᴏᴡ: [KUMBIPAAKAM](https://telegram.me/movies_seriesupdates)</b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🧿 ᴛɪᴛᴛʟᴇ :  {title} \n🌟 ʀᴀᴛɪɴɢ : {rating} \n🎭 ɢᴇɴʀᴇ : {genres} \n📆 ʀᴇʟᴇᴀsᴇ : {year} \n⏰ ᴅᴜʀᴀᴛɪᴏɴ : {runtime} \n🎙️ʟᴀɴɢᴜᴀɢᴇ : {languages} \n🔖 sʜᴏʀᴛ : {plot} \n★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : @Movies_Arena_4u")
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'openurl.pro')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '31c5e0f12c37535afccdfdf7067ef706799acb98')
